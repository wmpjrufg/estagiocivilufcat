...
<p align="justify">
    ...
    <br><br>
    O estágio será dividido em duas modalidades e serão classificados da seguinte forma:
</p>

<dl>
    <dt>Estágio Curricular Obrigatório (ECO)</dt>
        <dd><p align="justify">Estágio Curricular Obrigatório é uma componente curricular definida no projeto do curso, cuja carga horária (160h) é requisito para aprovação e obtenção de diploma.</p></dd>
...
<p align="justify">
    Além da <a href="https://estagio.catalao.ufg.br/p/37386-lei-n-11-788-de-25-de-setembro-de-2008" target="_blank">Lei nº 11788</a> o estágio na UFCAT é regulamentado por duas normativas internas: a Resolução <a href="https://files.cercomp.ufg.br/weby/up/610/o/Resolucao_CEPEC_2017_1538R.pdf?1622550731" target="_blank">CEPEC nº 1538R</a> e o <a href="https://prod.ufcat.edu.br:1337/uploads/RGCG_Resolucao_Consepec_7fa008ad3f.pdf" target="_blank">RGCG da UFCAT</a>.
    <br><br>
    ...
    <br><br>
    Durante o estágio, o aluno é orientado por um professor do Curso de Engenharia Civil e supervisionado por um técnico responsável (da empresa contratante) pelo acompanhamento das atividades desenvolvidas pelo estagiário. A escolha do orientador é iniciativa do aluno e dependerá da disponibilidade do professor.
    <br><br>
    O discente poderá adentrar no Estágio Curricular Não Obrigatório (ECNO) quando atingir 25% da carga horária total integralizada. Esta prática de estágio será regularizada por meio de um processo na ferramenta SEI (Sistema Eletrônico de Informações) e maiores informações para esta regularização são descritas na página do <a href="https://wmpjrufg.github.io/estagiocivilufcat/03_ecno.html" target="_blank">ECNO</a>.
    <br><br>
    O discente poderá cursar a componente curricular Estágio Supervisionado quando atingir 70% da carga horária total integralizada (<b>novo PPC</b>). A aprovação na componente será mediante a apresentação de um relatório final e o cumprimento das 160 hrs junto a empresa contratante. Maiores informações para esta regularização são descritas na página do <a href="https://wmpjrufg.github.io/estagiocivilufcat/04_eco.html" target="_blank">ECO</a>.
</p>
